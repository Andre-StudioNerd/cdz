const cavaleiros = [
  ...
  // Secundários
  {
    ...
    armadura: "Bronze",
    constelacao: "Unicórnio",
    golpes: ["Galope do Unicórnio"],
    imagem: "images/olhos_jabu.webp",
    imagemDetalhe: "images/jabu01.webp",
    descricao:
      "Jabu é um jovem de boa aparência, cabelos castanhos curtos ondulantes, olhos esverdeados (diferindo ligeiramente de sua versão mangá, onde os cabelos são pretos). Apesar de japonês, sua pele é mais morena que a de seus colegas, muito em razão do lugar para onde foi enviado para efetuar seu treinamento. Jabu foi posto sob tutela da Fundação Graad, vivendo por um tempo em um orfanato, junto a outros órfãos, recebendo treinamento físico moderado. Chega o dia em que cada menino seria enviado para diversas partes do mundo, com a missão de se tornarem Cavaleiros e trazerem de volta as Armaduras. Jabu foi enviando para Orã na Argélia, voltando de lá como Cavaleiro de Unicórnio. Jabu tem o controle básico do cosmo, podendo chegar a velocidade Mach 1, demonstrando também habilidades de combate corpo a corpo elevadas, principalmente no uso de suas pernas em combate. No anime demonstrou um nível básico de telecinesia ao desestabilizar Ban de Leão Menor com o cosmo emitido do chifre de seu elmo e ao encontrar com Seiya de Pégaso, quando este se recusa a deixar a Armadura, cortando as alças da urna de Pégaso com sua telecinesia.",
  },
  {
    id: "geki",
    categoria: "secundario",
    ...
    imagem: "images/olhos_geki.webp",
    imagemDetalhe: "images/geki01.webp",
    descricao:
      "Como sua constelação guardiã, Geki exibe uma compleição massuda, havendo começado a desenvolver o físico desde criança. Mesmo ainda na fase da adolescência, Geki tem um rosto másculo definido, de sobrancelhas pesadas e cabelos roxos (pretos no mangá) de pequenos olhos expressivos. Veste um macacão azul por baixo do traje sagrado. Geki foi mandado para as Montanhas Rochosas do Canadá, onde treinou por seis anos antes de receber a Armadura de Urso. Parte de seu treinamento envolvia lutas corpo-a-corpo com ursos selvagens, os quais Geki os estrangulava. Geki pertence à patente mais baixa do exército de Cavaleiros de Atena, a de Bronze. Assim sendo, possui controle básico da essência do Cosmo, o que lhe garante força sobre humana e alcançar a velocidade máxima de mach 1. Sua principal estratégia de batalha é baseada em sua imensa força física, já observada desde os tempos em que treinava pela conquista de sua Armadura contra ursos.",
  },
  {
    id: "ichi",
    categoria: "secundario",
